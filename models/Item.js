...
const ItemSchema = new mongoose.Schema({
    ...
    sellingPrice: { type: Number, required: true, min: 0 }, // Price item is sold at FROM warehouse
    mrp: { type: Number, min: 0 },                         // Max Retail Price

    hsnCode: { type: String, trim: true },
    uom: { type: String, required: true, enum: UOM_ENUM, default: 'pcs' },
    gstRate: { type: Number, required: true, min: 0, max: 100, default: 0 }, // Store as percentage, e.g., 18 for 18%
